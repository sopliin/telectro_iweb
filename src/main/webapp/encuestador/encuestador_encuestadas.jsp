...
<head>
    ...
    <title>Encuestas del Encuestador - ONU Mujeres</title>
    ...
    <style>
        ...
        .status-container {
            display: flex; /* Para alinear el punto y el texto */
            align-items: center;
        ...
        /* Colores de los puntos según el estado */
        .status-dot.dot-success {
            background-color: #28a745; /* Verde */
        }

        .status-dot.dot-warning {
            background-color: #f1a128; /* Naranja (o el color que use tu badge bg-warning) */
        }
        ...
        .status-text {
            color: #495057; /* Un color de texto oscuro pero suave */
            font-weight: 350; /* Ligeramente negrita para el texto del estado */
            font-size: 0.95em; /* Ajustar tamaño si es necesario */
        ...
        .table-hover thead th:nth-child(1) { /* Nombre - Columna 1 */
            min-width: 180px; /* Expandido para más espacio, ajusta si es necesario */
        }
        ...
        .table-hover thead th:nth-child(3) { /* Código - Columna 3 */
            min-width: 1rem;
        }

        .table-hover thead th:nth-child(4) { /* Estado - Columna 4 */
            min-width: 1rem;
        }

        .table-hover thead th:nth-child(5) { /* Fecha de asignación - Columna 5 */
            min-width: 1rem;
        }

        .table-hover thead th:nth-child(6) { /* Acciones - Columna 6 */
            min-width: 1rem;
            text-align: center; /* Centrar acciones si lo deseas */
        }
...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <%
            ...
            if (success != null && success.equals("encuestaCompletada")) {
        %>
            ...
            <div class="container-fluid p-0">
                ...
                <div class="row mb-3">
                    <div class="col-md-3">
                        ...
                        <form id="pageSizeForm" method="get" action="EncuestadorServlet">
                            ...
                            <input type="hidden" name="page" value="1"> <div class="col-auto">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title mb-0" style="font-size: 1.25rem">Lista de Encuestas</h5>
                    </div>
                    <div class="row">
                                        ...
                                        <table class="table table-hover my-0">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="d-none d-md-table-cell text-uppercase">Fecha De asignación</th>
                                            ...
                                            <%
                                                ...
                                                if (listaEncuestas != null && !listaEncuestas.isEmpty()) {
                                                    ...
                                                    // 1. Filtra encuestas activas en un solo bucle
                                                    ...
                                                    if (!encuestasActivas.isEmpty()) {
                                                        for (EncuestaAsignada encuesta : encuestasActivas) {
                                                            ...
                                                            if (encuesta.getEstado().equalsIgnoreCase("Completada")) {
                                                                // Formato del código con ceros a la izquierda para usuarioId y encuestaId
                                                                codigo = String.format("%02d-%03d", user.getUsuarioId(), encuesta.getEncuesta().getEncuestaId());
                                                            } else {
                                                                codigo = "N/A";
                                                            }
                                            %>
                                            ...
                                            // 3. Si NO hay activas, muestra mensaje
                                            else {
                                            %>
                                            <tr>
                                                <td colspan="7" class="text-center text">No tienes encuestas activas asignadas.</td>
                                            </tr>
                                            <%
                                                }
                                            }
                                            // 4. Si no hay encuestas asignadas
                                            else {
                                            %>
                                            <tr>
                                                <td colspan="7" class="text-center text">No hay encuestas asignadas.</td>
                                            </tr>
                                            <%
                                                }
                                            %>
...
<script type="text/javascript"
        src="<%=request.getContextPath()%>/onu_mujeres/static/js/app.js"></script>
<script>

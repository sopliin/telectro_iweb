...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<%=request.getContextPath()%>/onu_mujeres/static/css/app.css">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover my-0">
                                        ...
                                        <tr>
                                            ...
                                            <td><%= encuesta.getEncuesta().getNombre() %>
                                            </td>
                                            <td class="action-buttons">
                                                <button class="btn btn-sm btn-info" title="Ver detalles"
                                                        onclick="verDetalles(<%= encuesta.getEncuesta().getEncuestaId() %>)">
                                                    <i class="bi bi-eye"></i>
                                                </button>
                                            </td>
                                            <td class="d-none d-xl-table-cell"><%= codigo %>
                                            </td>
                                            <td>
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="7" class="text-center">No tienes encuestas activas asignadas.</td>
                                        </tr>
                                        <%
                                            }
                                        }

				...
				<div class="container-fluid p-0">
					...
					<div class="card">
						<div class="card-header">
							<h5 class="card-title mb-0" style="font-size: 1.25rem">Lista de Encuestas por Hacer</h5>
						</div>
						<div class="row">
								...
								<div class="card flex-fill">
									...
									<div class="table-responsive">
										<table class="table table-hover my-0">
											...
											%>
											<tr>
												<td colspan="4" class="text-center text">No tienes encuestas pendientes activas.</td>
											</tr>
											<%
												}
											} else {
											%>
											<tr>
												<td colspan="4" class="text-center text">No hay encuestas pendientes.</td>
											</tr>
											<%
												}
											%>

                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover my-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class=" d-xl-table-cell">Descripción</th>
                                            <th>Acciones</th>
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="4" class="text-center">No tienes encuestas en progreso
                                                activas.
                                            </td>
                                        </tr>
                                        <%
                                        ...
                                        %>
                                        <tr>
                                            <td colspan="4" class="text-center">No hay encuestas en progreso.</td>
                                        </tr>
                                        <%
                                            }
                                        %>

        ...
        <ul class="navbar-nav navbar-align">
          ...
          <li class="nav-item dropdown">
            ...
            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
              <img src="<%=request.getContextPath()%>/fotos/<%=user.getProfilePhotoUrl() %>" class="avatar img-fluid rounded me-1" alt="Charles Hall" /> <span class="text-dark"><%=user.getNombre()+" "+user.getApellidoPaterno() %></span>
            </a>
            <div class="dropdown-menu dropdown-menu-end">
              <a class="dropdown-item" href="AdminServlet?action=verPerfil"><i class="align-middle me-1" data-feather="pie-chart"></i> Ver Perfil</a>
        ...
        <div class="row">
          <div class="col-12">
            <div class="password-container">
              ...
              <form action="AdminServlet?action=actualizarPassword" method="post" id="passwordForm">
                <div class="mb-3">
                ...
                <div class="d-grid gap-2">
                  ...
                  <a href="AdminServlet?action=verPerfil" class="btn btn-secondary">Volver al perfil</a>
                </div>
              </form>
            </div>
          </div>

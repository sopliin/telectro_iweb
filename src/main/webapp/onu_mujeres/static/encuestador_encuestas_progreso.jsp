							...
							<div class="card flex-fill">
								...
								<table class="table table-hover my-0">
									...
									<tr>
										...
										<td class="d-none d-xl-table-cell"><button class="btn btn-sm btn-info" title="Ver detalles" onclick="verDetalles(<%= encuesta.getEncuesta().getEncuestaId() %>)">
											<i class="bi bi-eye"></i>
										</button>
										</td></td>
										<td class="table-action">
											<%
												...
												if (!"completa ".equalsIgnoreCase(encuesta.getEstado())) {
											%>
										...
										<td class="d-none d-md-table-cell">
											<%= encuesta.getFechaAsignacion() != null ? encuesta.getFechaAsignacion() : "N/A" %>
										</td>
									...
									%>
									<tr>
										<td colspan="7" class="text-center">No hay encuestas en progreso.</td>
									</tr>
									<%
										}
									%>
